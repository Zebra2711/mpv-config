...
function open_input_menu_uosc()
    ...
    local menu_props = {
        type = "menu_danmaku",
        title = "Enter the name of the anime here.",
...
local menu_items_config = {
    bold = { title = "Bold", hint = options.bold, original = options.bold,
        footnote = "true / false", },
    font_size_strict = { title = "Uniform font size", hint = options.font_size_strict, original = options.font_size_strict,
        footnote = "true / false", },
    fontsize = { title = "Font size", hint = options.fontsize, original = options.fontsize,
        scope = { min = 0, max = math.huge }, footnote = "Integer (>=0)", },
    outline = { title = "Outline", hint = options.outline, original = options.outline,
        scope = { min = 0.0, max = 4.0 }, footnote = "Range: (0.0-4.0)" },
    shadow = { title = "Shadow", hint = options.shadow, original = options.shadow,
        scope = { min = 0, max = math.huge }, footnote = "Integer (>=0)", },
    density = { title = "Density", hint = options.density, original = options.density,
        scope = { min = -1, max = math.huge }, footnote = "Integer (>=−1) -1：No overlap 0：Unlimited Others: Maximum number of items", },
    scrolltime = { title = "Scrolltime", hint = options.scrolltime, original = options.scrolltime,
        scope = { min = 1, max = math.huge }, footnote = "Integer (>=1)", },
    transparency = { title = "Transparency", hint = options.transparency, original = options.transparency,
        scope = { min = 0, max = 255 }, footnote = "Integer: 0 (Opaque) to 255 (Transparent)", },
    displayarea = { title = "Display area", hint = options.displayarea, original = options.displayarea,
        scope = { min = 0.0, max = 1.0 }, footnote = "Range: (0.0-1.0)", },
}
...
function open_add_total_menu_uosc()
    ...
    local total_menu_items_config = {
        { title = "Danmaku search", action = "open_search_danmaku_menu" },
        { title = "Add danmu from source", action = "open_add_source_menu" },
        { title = "Danmaku source delay settings", action = "open_source_delay_menu" },
        { title = "Danmaku style", action = "open_setup_danmaku_menu" },
        { title = "Danmaku content", action = "open_content_danmaku_menu" },
    }
